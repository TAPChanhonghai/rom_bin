...
extern uint32_t                 Timer1;  /**< 1000Hz decrement timer */
static USART_TypeDef            *spi;
...
void MICROSD_init(void)
{
  ...
  spi->ROUTE = USART_ROUTE_TXPEN | USART_ROUTE_RXPEN | USART_ROUTE_CLKPEN | MICROSD_LOC;
  /* Enabling TX and RX */
  ...
  GPIO_PinModeSet(MICROSD_GPIOPORT, MICROSD_CSPIN, gpioModePushPull, 0);  /* CS */
  GPIO_PinModeSet(MICROSD_GPIOPORT, MICROSD_CLKPIN, gpioModePushPull, 0);  /* Clock */
}
 ...
 *	Response value
 *****************************************************************************/
uint8_t send_cmd(uint8_t cmd, DWORD arg)
{
  uint8_t         n, res;
  ...
  xfer_spi((uint8_t)(arg >> 24));    /* Argument[31..24] */
  xfer_spi((uint8_t)(arg >> 16));    /* Argument[23..16] */
  xfer_spi((uint8_t)(arg >> 8));     /* Argument[15..8] */
  xfer_spi((uint8_t) arg);           /* Argument[7..0] */
